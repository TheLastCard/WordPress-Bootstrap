...
function html5blank_styles()
{
    ...
    wp_register_style('bootstrap3', get_template_directory_uri() . '/css/bootstrap.min.css', array(), '3.2.0', 'all');
    wp_enqueue_style('bootstrap3'); // Enqueue it!

    wp_register_style('bootstrap3_theme', get_template_directory_uri() . '/css/bootstrap-theme.min.css', array(), '3.2.0', 'all');
    wp_enqueue_style('bootstrap3_theme'); // Enqueue it!
}
...
?>
	...
	<?php printf(__('<cite class="fn">%s</cite> <span class="says">sier:</span>'), get_comment_author_link()) ?>
	</div>
<?php if ($comment->comment_approved == '0') : ?>
	<em class="comment-awaiting-moderation"><?php _e('Kommentaren din venter på gjennomgang.') ?></em>
	<br />
<?php endif; ?>
